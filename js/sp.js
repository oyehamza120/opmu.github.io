...
function _typeof(e) {
        ...
        o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = {
            ...
            bytesToBase64: function(e) {
                for (var t = [], n = 0; n < e.length; n += 3)
                    for (var r = e[n] << 16 | e[n + 1] << 8 | e[n + 2], a = 0; a < 4; a++) 8 * n + 6 * a <= 8 * e.length ? t.push(o.charAt(r >>> 6 * (3 - a) & 63)) : t.push("=");
                return t.join("")
            },
    ...
    57: [function(e, t, n) {
        ...
        t.exports = function(o, i) {
            return function(e, t) {
                if (null == e) return e;
                if (!c(e)) return o(e, t);
                for (var n = e.length, r = i ? n : -1, a = Object(e);
                    (i ? r-- : ++r < n) && !1 !== t(a[r], r, a););
                return e
            }
        }
        ...
        ! function() {
            ...
            (void 0 !== n ? n : this).InQueueManager = function(r, a, o, e, i) {
                ...
                function m(e) {
                    var t = [];
                    if (e && 0 !== e.length)
                        for (var n = 0; n < e.length; n++) p.hasOwnProperty(e[n]) ? t.push(p[e[n]]) : y.warn('Warning: Tracker namespace "' + e[n] + '" not configured');
                    else t = c(p);
                ...
                function t() {
                    ...
                    for (e = 0; e < arguments.length; e += 1) {
                        ...
                        if (d = void 0, i = (o = [(d = a.split(":"))[0], 1 < d.length ? d[1].split(";") : []])[1], "newTracker" !== (n = o[0]))
                            ...
                            else s = n, u = r[0], l = r[1], f = void 0, y.warn(s + " is deprecated. Set the collector when a new tracker instance using newTracker."), v(f = h(l) ? "sp" : l), p[f][s](u);
                        else v(r[0], r[1], r[2])
                    }
                }
        ...
        ! function() {
            ...
            s.hasSessionStorage = function() {
                ...
                if (l.mimeTypes && l.mimeTypes.length)
                    for (n in a) Object.prototype.hasOwnProperty.call(a, n) && (r = l.mimeTypes[a[n]], o[n] = r && r.enabledPlugin ? "1" : "0");
    ...
    172: [function(e, t, c) {
        ! function() {
            ...
            }, u.attemptGetSessionStorage = function(e) {
                try {
                    return sessionStorage.getItem(e)
                } catch (e) {
                    return
                }
            }, u.attemptWriteSessionStorage = function(e, t) {
                try {
    ...
    177: [function(e, t, n) {
        ! function() {
            var nt = e("lodash/forEach"),
                rt = e("lodash/map"),
                at = e("./lib/helpers"),
                ot = e("./lib/proxies"),
                it = e("browser-cookie-lite"),
                ct = e("./lib/detectors"),
                st = e("sha1"),
                ut = e("./links"),
                lt = e("./forms"),
                ft = e("./errors"),
                dt = e("./out_queue"),
                pt = e("snowplow-tracker-core").trackerCore,
                mt = e("./guard").productionize,
                vt = e("uuid");
            (void 0 !== n ? n : this).Tracker = function(e, t, n, f, r) {
                ...
                var m, a, v, d, o, i, h, c, p, s, u, l, g, y, _, b, w, k, A, x, S = Object.freeze({
                        consent: "consent",
                        contract: "contract",
                    ...
                    C = pt(!0, function(e) {
                        ! function(e) {
                            var t, n = Math.round((new Date).getTime() / 1e3),
                                r = Oe("id"),
                                a = Oe("ses"),
                                o = Te("ses"),
                                i = Ue(),
                                ...
                                p = i[6];
                            t = !!h && !!it.cookie(h);
                            if ((J || t) && "none" != ne) return "localStorage" == ne ? (at.attemptWriteLocalStorage(r, ""), at.attemptWriteLocalStorage(a, "")) : "cookie" != ne && "cookieAndLocalStorage" != ne || (it.cookie(r, "", -1, K, H), it.cookie(a, "", -1, K, H));
                            "0" === c ? (b = p, o || "none" == ne || (l++, d = f, b = vt.v4()), se = l) : (new Date).getTime() - ie > 1e3 * Q && (b = vt.v4(), se++);
                            e.add("vp", ct.detectViewport()), e.add("ds", ct.detectDocumentSize()), e.add("vid", se), e.add("sid", b), e.add("duid", s), e.add("uid", w), Ae(), e.add("refr", Ce(m || F)), e.add("url", Ce(v || N)), "none" != ne && (Fe(s, u, se, n, d, b), Ne());
                            ie = (new Date).getTime()
                        }(e),
                        function(e, t) {
                            var n, r = new Date;
                            n = !!h && !!it.cookie(h);
                            J || n || (pe.enqueueRequest(e.build(), a), f.expireDateTime = r.getTime() + t)
                        }(e, R)
                    }),
                    j = !1,
                    O = {},
                    ...
                    E = window,
                    D = navigator,
                    L = ot.fixupUrl(I.domain, E.location.href, at.getReferrer()),
                    M = at.fixupDomain(L[0]),
                    N = L[1],
                    F = L[2],
                    ...
                    K = "/",
                    W = D.doNotTrack || D.msDoNotTrack || E.doNotTrack,
                    J = !!r.hasOwnProperty("respectDoNotTrack") && (r.respectDoNotTrack && ("yes" === W || "1" === W)),
                    Y = r.hasOwnProperty("cookieLifetime") ? r.cookieLifetime : 63072e3,
                    Q = r.hasOwnProperty("sessionCookieTimeout") ? r.sessionCookieTimeout : 1800,
                    $ = I.characterSet || I.charset,
                    X = !!r.hasOwnProperty("forceSecureTracker") && !0 === r.forceSecureTracker,
                    Z = !(X || !r.hasOwnProperty("forceUnsecureTracker")) && !0 === r.forceUnsecureTracker,
                    ee = !r.hasOwnProperty("useLocalStorage") || (at.warn("argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead."), r.useLocalStorage),
                    te = !r.hasOwnProperty("useCookies") || (at.warn("argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead."), r.useCookies),
                    ne = r.hasOwnProperty("stateStorageStrategy") ? r.stateStorageStrategy : te || ee ? te && ee ? "cookieAndLocalStorage" : te ? "cookie" : "localStorage" : "none",
                    re = D.userLanguage || D.language,
                    ae = ct.detectBrowserFeatures("cookie" == ne || "cookieAndLocalStorage" == ne, Oe("testcookie")),
                    oe = e + "_" + t,
                    ie = (new Date).getTime(),
                    ce = st,
                    se = 1,
                    ...
                    le = ut.getLinkTrackingManager(C, oe, Ge),
                    fe = lt.getFormTrackingManager(C, oe, Ge),
                    de = ft.errorManager(C),
                    pe = new dt.OutQueueManager(e, t, f, "localStorage" == ne || "cookieAndLocalStorage" == ne, r.eventMethod, U, r.bufferSize, r.maxPostBytes || 4e4, r.useStm, r.maxLocalStorageQueueSize || 1e3),
                    me = !1,
                    ve = r.contexts || {},
                    he = [],
                    ge = [],
                    ...
                    we = {};
                for (var ke in r.hasOwnProperty("discoverRootDomain") && r.discoverRootDomain && (H = at.findRootDomain()), ve.gaCookies && he.push((k = {}, nt(["__utma", "__utmb", "__utmc", "__utmv", "__utmz", "_ga"], function(e) {
                        var t = it.cookie(e);
                        t && (k[e] = t)
                    }), {
                        schema: "iglu:com.google.analytics/cookies/jsonschema/1-0-0",
                        data: k
                    })), ve.geolocation && He(), C.setBase64Encoding(!r.hasOwnProperty("encodeBase64") || r.encodeBase64), C.setTrackerVersion(n), C.setTrackerNamespace(t), C.setAppId(B), C.setPlatform(z), C.setTimezone(ct.detectTimezone()), C.addPayloadPair("lang", re), C.addPayloadPair("cs", $), ae) Object.prototype.hasOwnProperty.call(ae, ke) && ("res" === ke || "cd" === ke || "cookie" === ke ? C.addPayloadPair(ke, ae[ke]) : C.addPayloadPair("f_" + ke, ae[ke]));

                function Ae() {
                    (L = ot.fixupUrl(I.domain, E.location.href, at.getReferrer()))[1] !== N && (F = at.getReferrer(N)), M = at.fixupDomain(L[0]), N = L[1]
                }

                function xe() {
                    var e = (new Date).getTime();
                    this.href && (this.href = at.decorateQuerystring(this.href, "_sp", _ + "." + e))
                }

                function Se(e) {
                    for (var t = 0; t < I.links.length; t++) {
                        var n = I.links[t];
                        !n.spDecorationEnabled && e(n) && (at.addEventListener(n, "click", xe, !0), at.addEventListener(n, "mousedown", xe, !0), n.spDecorationEnabled = !0)
                    }
                }
                ...
                function Te(e) {
                    var t = Oe(e);
                    return "localStorage" == ne ? at.attemptGetLocalStorage(t) : "cookie" == ne || "cookieAndLocalStorage" == ne ? it.cookie(t) : void 0
                }

                function Pe() {
                    Ae(), y = ce((H || M) + (K || "/")).slice(0, 4)
                }
                ...
                function Fe(e, t, n, r, a, o) {
                    ze(Oe("id"), e + "." + t + "." + n + "." + r + "." + a + "." + o, Y)
                }

                function ze(e, t, n) {
                    "localStorage" == ne ? at.attemptWriteLocalStorage(e, t, n) : "cookie" != ne && "cookieAndLocalStorage" != ne || it.cookie(e, t, n, K, H)
                }
                ...
                function Ue() {
                    ...
                    var e, t = new Date,
                        ...
                        r = Te("id");
                    return r ? (e = r.split(".")).unshift("0") : e = ["1", _, n, 0, n, ""], e[6] || (e[6] = vt.v4()), e
                }

                function Be(e) {
                    return X ? "https://" + e : Z ? "http://" + e : ("https:" === I.location.protocol ? "https" : "http") + "://" + e
                }

                function Ge(e) {
                    var t = he.concat(e || []);
                    if (ve.webPage && t.push({
                            schema: "iglu:com.snowplowanalytics.snowplow/web_page/jsonschema/1-0-0",
                            data: {
                                id: Re()
                            }
                        }), ve.performanceTiming) {
                        var n = function() {
                    ...
                    if (E.optimizely) {
                        ...
                        if (ve.optimizelyExperiments)
                            for (var a = function() {
                                    var e = qe("experiments");
                                    if (e) {
                                        var t = [];
                                        for (var n in e)
                        ...
                        if (ve.optimizelyAudiences) {
                            var u = function() {
                                var e = qe("visitor", "audiences");
                                if (e) {
                                    var t = [];
                                    for (var n in e)
                                        if (e.hasOwnProperty(n)) {
                        ...
                        if (ve.optimizelyDimensions) {
                            var l = function() {
                                var e = qe("visitor", "dimensions");
                                if (e) {
                                    var t = [];
                                    for (var n in e)
                                        if (e.hasOwnProperty(n)) {
                    ...
                    if (ve.gdprBasis && we.gdprBasis) {
                        var d = function() {
                            if (we.gdprBasis) return {
                                schema: "iglu:com.snowplowanalytics.snowplow/gdpr/jsonschema/1-0-0",
                                data: {
                                    basisForProcessing: we.gdprBasis,
                                    documentId: we.gdprDocId || null,
                                    documentVersion: we.gdprDocVer || null,
                                    documentDescription: we.gdprDocDesc || null
                                }
                            }
                        }();
                        d && t.push(d)
                ...
                function Re() {
                    return null == f.pageViewId && (f.pageViewId = vt.v4()), f.pageViewId
                }
                ...
                function He() {
                    !me && D.geolocation && D.geolocation.getCurrentPosition && (me = !0, D.geolocation.getCurrentPosition(function(e) {
                        var t = e.coords,
                            n = {
                ...
                function We(e, t, n, r) {
                    Ae(), _e && (ye && null != f.pageViewId || (f.pageViewId = vt.v4())), _e = !0, G = I.title, d = e;
                    var a = at.fixupTitle(d || G);
                    C.trackPageView(Ce(v || N), a, Ce(m || F), Ge(Ke(t, n)), r);
                    var o = new Date,
                        i = !1;
                    if (be.enabled && !be.installed) {
                        ...
                        Object.prototype.hasOwnProperty.call(c, "hasSupport") ? at.addEventListener(I, s, Ie, {
                            passive: !0
                        }) : at.addEventListener(I, s, Ie), Le(), at.addEventListener(I, "click", Ie), at.addEventListener(I, "mouseup", Ie), at.addEventListener(I, "mousedown", Ie), at.addEventListener(I, "mousemove", Ie), at.addEventListener(E, "scroll", Ee), at.addEventListener(I, "keypress", Ie), at.addEventListener(I, "keydown", Ie), at.addEventListener(I, "keyup", Ie), at.addEventListener(E, "resize", Ie), at.addEventListener(E, "focus", Ie), at.addEventListener(E, "blur", Ie)
                    }
                    if (be.enabled && (q || i))
                        for (var u in p = o.getTime(), be.configurations)
                            if (be.configurations.hasOwnProperty(u)) {
                                var l = be.configurations[u];
                                clearInterval(l.activityInterval), l.activityInterval = Je(_objectSpread({}, l, {
                ...
                function Je(e) {
                    ...
                    return setInterval(function() {
                        var e = new Date;
                        p + t > e.getTime() && r + 1e3 * n < e.getTime() && (Ae(), a({
                            context: o,
                            pageViewId: Re(),
                            minXOffset: s,
                            minYOffset: l,
                ...
                function Ye(e, t, n) {
                    return e === parseInt(e, 10) && t === parseInt(t, 10) ? {
                        ...
                        callback: n
                    } : (at.warn("Activity tracking not enabled, please provide integer values for minimumVisitLength and heartBeatDelay."), {})
                }
                ...
                function Qe(e) {
                    var t = e.context,
                        ...
                        o = e.maxYOffset,
                        i = I.title;
                    i !== G && (G = i, d = null), C.trackPagePing(Ce(v || N), at.fixupTitle(d || G), Ce(m || F), Me(n), Me(a), Me(r), Me(o), Ge(t))
                }
                ...
                function Xe(t) {
                    ...
                    if (!c)
                        for (n = 0; n < a.length; n++) {
                            if (I[$e(r = a[n], "hidden")]) {
                                "prerender" === I[$e(r, "visibilityState")] && (e = !0);
                                break
                            }
                            if (!1 === I[$e(r, "hidden")]) break
                        }
                    e ? at.addEventListener(I, r + "visibilitychange", function e() {
                ...
                Pe(), A = "none" != ne && !!Te("ses"), (x = Ue())[1] ? _ = x[1] : (_ = vt.v4(), x[1] = _), b = x[6], A || (x[3]++, b = vt.v4(), x[6] = b, x[5] = x[4]), "none" != ne && (Ne(), x[4] = Math.round((new Date).getTime() / 1e3), x.shift(), Fe.apply(null, x)), r.crossDomainLinker && Se(r.crossDomainLinker);
                var et = "User Fingerprinting is no longer supported. This function will be removed in a future release.",
                    tt = " is deprecated. Instead use the argmap argument on tracker initialisation: ";
                return O.getDomainSessionIndex = function() {
                    ...
                    var e = Math.round((new Date).getTime() / 1e3),
                        ...
                        c = t[5],
                        s = t[6];
                    "0" === n ? (b = s, "none" != ne && (o++, c = i, b = vt.v4()), se = o, Ne()) : (b = vt.v4(), se++), "none" != ne && (Fe(r, a, se, e, c, b), Ne()), ie = (new Date).getTime()
                    ...
                    at.warn("setAppId" + tt + "appId"), C.setAppId(e)
                }, O.setReferrerUrl = function(e) {
                    m = e
                }, O.setCustomUrl = function(e) {
                    Ae(), v = function(e, t) {
                        var n;
                        return je(t) ? t : "/" === t.slice(0, 1) ? je(e) + "://" + at.getHostName(e) + t : (0 <= (n = (e = Ce(e)).indexOf("?")) && (e = e.slice(0, n)), (n = e.lastIndexOf("/")) !== e.length - 1 && (e = e.slice(0, n + 1)), e + t)
                    }(N, e)
                    ...
                    at.warn("setCookieNamePrefix" + tt + "cookieName"), V = e
                }, O.setCookieDomain = function(e) {
                    at.warn("setCookieDomain" + tt + "cookieDomain"), H = at.fixupDomain(e), Pe()
                }, O.setCookiePath = function(e) {
                    K = e, Pe()
                }, O.setVisitorCookieTimeout = function(e) {
                    Y = e
                }, O.setSessionCookieTimeout = function(e) {
                    at.warn("setSessionCookieTimeout" + tt + "sessionCookieTimeout"), Q = e
                }, O.setUserFingerprintSeed = function() {
                    at.warn(et)
                }, O.enableUserFingerprint = function() {
                    at.warn(et)
                }, O.respectDoNotTrack = function(e) {
                    at.warn("respectDoNotTrack" + tt + "respectDoNotTrack");
                    var t = D.doNotTrack || D.msDoNotTrack;
                    J = e && ("yes" === t || "1" === t)
                }, O.crossDomainLinker = function(e) {
                    Se(e)
                }, O.enableLinkClickTracking = function(e, t, n, r) {
                    f.hasLoaded ? (le.configureLinkClickTracking(e, t, n, r), le.addClickListeners()) : f.registeredOnLoadHandlers.push(function() {
                        le.configureLinkClickTracking(e, t, n, r), le.addClickListeners()
                    })
                }, O.refreshLinkClickTracking = function() {
                    f.hasLoaded ? le.addClickListeners() : f.registeredOnLoadHandlers.push(function() {
                        le.addClickListeners()
                    })
                }, O.enableActivityTracking = function(e, t) {
                    be.enabled = !0, be.configurations.pagePing = Ye(e, t, Qe)
                }, O.enableActivityTrackingCallback = function(e, t, n) {
                    be.enabled = !0, be.configurations.callback = Ye(e, t, n)
                }, O.updatePageActivity = function() {
                    Ie()
                }, O.enableFormTracking = function(e, t) {
                    f.hasLoaded ? (fe.configureFormTracking(e), fe.addFormListeners(t)) : f.registeredOnLoadHandlers.push(function() {
                        fe.configureFormTracking(e), fe.addFormListeners(t)
                    })
                    ...
                    Ae(), w = at.fromQuerystring(e, N)
                }, O.setUserIdFromReferrer = function(e) {
                    Ae(), w = at.fromQuerystring(e, F)
                }, O.setUserIdFromCookie = function(e) {
                    w = it.cookie(e)
                }, O.setCollectorCf = function(e) {
                    a = function(e) {
                        return Be(e + ".cloudfront.net")
                    }(e)
                }, O.setCollectorUrl = function(e) {
                    a = Be(e)
                }, O.setPlatform = function(e) {
                    at.warn("setPlatform" + tt + "platform"), C.setPlatform(e)
                }, O.encodeBase64 = function(e) {
                    at.warn("encodeBase64" + tt + "encodeBase64"), C.setBase64Encoding(e)
                }, O.flushBuffer = function() {
                    pe.executeQueue()
                }, O.enableGeolocationContext = He, O.trackPageView = function(e, t, n, r) {
                    Xe(function() {
                        We(e, t, n, r)
                    })
                }, O.trackStructEvent = function(e, t, n, r, a, o, i) {
                    Xe(function() {
                        C.trackStructEvent(e, t, n, r, a, Ge(o), i)
                    })
                }, O.trackSelfDescribingEvent = function(e, t, n) {
                    Xe(function() {
                        C.trackSelfDescribingEvent(e, Ge(t), n)
                    })
                    ...
                    Xe(function() {
                        ! function(e, t, n, r, a, o, i, c, s, u, l) {
                            C.trackEcommerceTransaction(e, t, n, r, a, o, i, c, s, Ge(u), l)
                        }(ue.transaction.orderId, ue.transaction.affiliation, ue.transaction.total, ue.transaction.tax, ue.transaction.shipping, ue.transaction.city, ue.transaction.state, ue.transaction.country, ue.transaction.currency, ue.transaction.context, ue.transaction.tstamp);
                        for (var e = 0; e < ue.items.length; e++) {
                            var t = ue.items[e];
                            n = t.orderId, r = t.sku, a = t.name, o = t.category, i = t.price, c = t.quantity, s = t.currency, u = t.context, l = t.tstamp, C.trackEcommerceTransactionItem(n, r, a, o, i, c, s, Ge(u), l)
                        }
                    ...
                    Xe(function() {
                        C.trackConsentWithdrawn(e, t, n, r, a, Ge(o), i)
                    })
                }, O.trackConsentGranted = function(e, t, n, r, a, o, i) {
                    Xe(function() {
                        C.trackConsentGranted(e, t, n, r, a, Ge(o), i)
                    })
                }, O.trackEnhancedEcommerceAction = function(e, t, n) {
                    var r = ge.concat(t || []);
                    ge.length = 0, Xe(function() {
                        C.trackSelfDescribingEvent({
